...
- (IBAction)systemAlertView:(id)sender {
    UIAlertView *alertView = [[UIAlertView alloc] initWithTitle:@"提示" message:@"系统alertview" delegate:self cancelButtonTitle:@"取消" otherButtonTitles:@"确定",@"button1",@"button3",@"button2", nil];
    [alertView show];
}
