...
- (IBAction)systemAlertView:(id)sender {
    UIAlertView *alertView = [[UIAlertView alloc] initWithTitle:@"提示" message:@"系统alertview" delegate:self cancelButtonTitle:@"取消" otherButtonTitles:@"确定",@"button1",@"button3",@"button2",@"button4",@"button5",@"button6",@"button7",@"button8",@"button9",@"button10",@"button11",@"button13",@"button12",@"button14",@"button15",@"button16",@"button17",@"button18",@"button19",@"button20",@"button21",@"button23", nil];
    [alertView show];
}
